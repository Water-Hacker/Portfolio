...
const pillars = [
    ...
    cases: [
      {
        ...
        detail: 'Identified a permission escalation logic bypass in the WhatsApp iOS client. Non-admin users could forward screenshots within restricted group environments, circumventing broadcast controls. Reported to Meta under responsible disclosure; patched.',
      ...
      },
      {
        ...
        detail: 'Discovered a character misinterpretation flaw between the clipboard and system dialpad. Certain Unicode sequences caused unexpected behavior in the dialer input parser, creating a potential injection vector. Reported to Samsung in 2025 under coordinated disclosure; not yet patched.',
  ...
  },
  {
    ...
    cases: [
      {
        id: 'CASE-VIGIL-001', client: 'VIGIL APEX — Sovereign Anti-Corruption Intelligence', year: '2025–2026',
