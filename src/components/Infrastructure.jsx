...
const pillars = [
  ...
  },
  {
    ...
    cases: [
      ...
      {
        id: 'CASE-GUC-001', client: 'GUC (Got U Connected) — RHIBMS Buea, Cameroon', year: '2024',
        type: 'RHIBMS Buea Student & Staff Platform — Cross-Platform Flutter App', badge: 'DEPLOYED', badgeClass: 'badge-active',
        detail: 'Architected and deployed GUC (Got U Connected) — a cross-platform Flutter / Dart student-and-staff app for RHIBMS Buea (Higher Institute, Buea, South-West Region, Cameroon). The platform integrates academic tracking, internal social networking, anonymous confessions, academic queries, lost-and-found, location services, and user-controlled news / events, with usability telemetry feeding continuous improvement. iOS + Android + web from a single Flutter codebase. Serves the entire RHIBMS Buea community — students, staff, and administration — and remains the institution\'s sanctioned community platform.',
        tech: ['Flutter', 'Dart', 'Firebase', 'Cloud Firestore', 'Cross-Platform Mobile', 'iOS', 'Android', 'Real-Time Sync', 'Location Services', 'Anonymous Channels', 'University Information Systems', 'Cameroon'],
      },
    ],
  },
  {
